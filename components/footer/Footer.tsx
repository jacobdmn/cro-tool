...
const Footer: React.FC<FooterProps> = ({ showResult, enteringEmailStage }) => {
  ...
  const styles = {
    ...
    quizpage_footer1: `quizpage_footer1 px-4 h-96 grid place-content-center container max-w-full mx-auto relative ${
